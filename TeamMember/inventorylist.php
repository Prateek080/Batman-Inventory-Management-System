...
if (isset($_SESSION['view']))
{
	...
	?>
		...
		<article class="module width_full">
			...
			<header><h3>Inventories</h3></header>
...
echo "</tr>";
 while($row1 = $sql->fetch(PDO::FETCH_ASSOC))
  ...
  echo "<tr>";
  echo   "<td>" . $row1['inventory_id'] . "</td><td style='height:50: width:200':>" . $row1['name'] . "</td><td>". $row1['category'] ."</td><td>". $row1['threshold'] ."</td><td>" . $row1['cost'] . "</td><td>". $row1['count'] ."</td><td><form action='inventorydetail.php' method='POST'><input type='hidden' name='id' value='". $row1['inventory_id'] ."'></input><input type='submit' value='Details'></input></form></td>";
  echo "</tr>";
